                        ...
                        <div class="form">
                            <form action="<?php echo site_url('admin/updateabout/'.$viewabout->id)?>" method="post" enctype="multipart/form-data">
                                <div class="input_field">
                                    <label>Title</label>
                                    <input type="text" name="title" class="input" placeholder="Enter Your messeage" value="<?php echo $viewabout->title;?>">
                                </div>
                                <div class="input_field">
                                    <label>Paragraph</label>
                                 <textarea class="textarea" name="paragraph" placeholder="Enter Your messeage"><?php echo $viewabout->paragraph;?></textarea>
                                </div>
