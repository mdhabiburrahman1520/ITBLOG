                    ...
                    <div class="title">
                        Add Header
                            ...
                            <div class="input_field">
                                ...
                                <input type="text" class="input" name="headline" placeholder="Enter Your messeage..." value="<?php echo $viewheader->headline;?>">
                            </div>

                            <div class="input_field">
                                <label>Paragraph</label>
                             <textarea class="textarea" name="paragraph" placeholder="Enter Your messeage..."><?php echo $viewheader->paragraph;?></textarea>
                            </div>

                            <div class="input_field">
                                <label>Button-Caption</label>
                                <input type="text" class="input" name="btn-caption" placeholder="Enter Your messeage..." value="<?php echo $viewheader->buttoncaption;?>">
                            </div>
