                        ...
                        <div class="form">
                            <form action="<?php echo site_url('admin/updateinformation/'.$viewinformation->id)?>" method="post" enctype="multipart/form-data">
                                <div class="input_field">
                                    <label>Address</label>
                                 <textarea class="textarea" name="address" placeholder="Enter Your messeage..."><?php echo $viewinformation->address;?></textarea>
                                </div>
                                <div class="input_field">
                                    <label>Phone</label>
                                    <input type="text" class="input" name="phone" placeholder="Enter Your messeage..." value="<?php echo $viewinformation->phone;?>">
                                </div>
                                
                                <div class="input_field">
                                    <label>Email</label>
                                    <input type="text" class="input" name="email" placeholder="Enter Your messeage..." value="<?php echo $viewinformation->email;?>">
                                </div>
