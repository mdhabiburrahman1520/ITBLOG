                        ...
                        <div class="form">
                            <form action="<?php echo site_url('admin/updatemessage/'.$viewmessage->id)?>" method="post" enctype="multipart/form-data">
                                <div class="input_field">
                                    ...
                                    <input type="text" class="input" name="fullname" placeholder="Enter Your messeage..." value="<?php echo $viewmessage->fullname;?>">
                                </div>
                                <div class="input_field">
                                    <label>Email</label>
                                    <input type="text" class="input" name="email" placeholder="Enter Your messeage..." value="<?php echo $viewmessage->email;?>">
                                </div>
                                <div class="input_field">
                                    <label>Message</label>
                                 <textarea class="textarea" name="message" placeholder="Enter Your messeage..."><?php echo $viewmessage->message;?></textarea>
                                </div>
