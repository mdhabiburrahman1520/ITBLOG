                        ...
                        <form action="<?php echo site_url('admin/updateourteam/'.$viewourteam->id)?>" method="post" enctype="multipart/form-data">
                            <form action="">
                                <div class="input_field">
                                    <label>Name</label>
                                    <input type="text" name="name" class="input" placeholder="Enter Your messeage" value="<?php echo $viewourteam->name;?>">
                                </div>
                                <div class="input_field">
                                    <label>Position Title</label>
                                    <input type="text" name="positiontitle" class="input" placeholder="Enter Your messeage" value="<?php echo $viewourteam->positiontitle;?>">
                                </div>
