...
<html>
               ...
               <div class="sidebar-menu">
                ...
                <li class="item" id="posts">
                    <a href="#posts" class="menu-btn">
                        <i class="fa fa-list-ul"></i><span>Posts<i class="fas fa-chevron-down drop-down"></i></span>
                    </a>
                    <div class="sub-menu">
                        <a href="<?php echo base_url();?>addpost">
                            <i class="fa fa-plus" aria-hidden="true"></i><span>Add Post</span>
                        </a>  
                        <a href="<?php echo base_url();?>editpost">
                            <i class="fa fa-edit" aria-hidden="true"></i><span>Edit Post</span>
                        </a>  
                    </div>
                </li>  
                ...
                <li class="item">
                    <a href="<?php echo base_url();?>recipe" class="menu-btn">
            ...
            <div class="main-container">
                <div class="wrapper_main">
                    <div class="title">
                        ...
                        <a class="btn" href="http://localhost/ci/addheader" role="button">Add Header</a>
  ...
  <tbody>
    ...
    <th scope="row"><?php echo $hdr->id;?></th>
      <td><?php echo $hdr->headline;?></td>
      <td><?php echo substr($hdr->paragraph,0,20);?></td>
      <td><?php echo $hdr->buttoncaption;?></td>
      <td><?php echo $hdr->logo;?></td>
      <td><?php echo $hdr->background;?></td>
